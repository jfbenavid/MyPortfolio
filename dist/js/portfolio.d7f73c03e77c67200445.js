...
/******/ 	__webpack_require__.p = "C:\\Users\\jfben\\OneDrive\\Desktop\\portfolio\\dist/";
/******/
/******/
...
var _dataEng = __webpack_require__(16);

var _dataEng2 = _interopRequireDefault(_dataEng);
...
var _photo3 = __webpack_require__(23);
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _Header2.default,
                    null,
                    _react2.default.createElement(_photo2.default, { photo: _photo4.default, altPhoto: 'Fabian Benavides' }),
                    _react2.default.createElement(
                        _info2.default,
                        _dataEng2.default.mainInfo,
                        _react2.default.createElement(_contact2.default, _dataEng2.default.information)
                    )
                ),
                _react2.default.createElement(
                    _main2.default,
                    null,
                    _react2.default.createElement(_profile2.default, _dataEng2.default.profile),
                    _react2.default.createElement(_jobs2.default, _dataEng2.default.jobs)
                )
            );
        }
    }]);
...
module.exports = {"mainInfo":{"name":"Jose Fabian Benavides Moreno","occupation":"Software Developer"},"information":{"emailDescription":"E-mail","phoneDescription":"Phone","socialNetworks":{"linkedin":"https://www.linkedin.com/in/jos%C3%A9-fabian-benavides-moreno-1747b092/?locale=en_US","github":"https://github.com/jfbenavid"}},"profile":{"profile":"Software Developer with 3 years of experience developing web applications and windows services with c#.Net as development language; with knowledges in Python, Django, PHP and frameworks like Angular, Vue and React.","profileDescription":"Profile"},"jobs":{"experienceDescription":"Experience","functionDescription":"Functions","achievementsDescription":"Achievements","jobs":[{"id":3,"jobTitle":"Software Developer","company":"Inalambria Internacional","time":"Mar 2016 - Currently","jobFunctions":[{"id":311,"description":"Develop REST APIs, with Windows services and web apps using Microsoft technologies."},{"id":312,"description":"Help to develop new functionalities and fix bugs in the platform(core of the business)."},{"id":313,"description":"Paticipant developing a new component to process files to dispatch messages more efficiently."}],"jobAchievements":[{"id":321,"description":"Create a service to get more efficient information about the core of the business."},{"id":322,"description":"Help with the architecture design of a new sms dispatch platform."},{"id":323,"description":"Help to introduce and apply software programming best practices in the area."}]},{"id":2,"jobTitle":"Degree project","company":"Fundación Universitaria Tecnológico Comfenalco","time":"Mar 2015 - Jan 2016","jobFunctions":[{"id":211,"description":"Develop a web application to manage a domotic central and use it with a prototype made with a Raspberry Pi."},{"id":212,"description":"The application is able to dimmer and turn the light on/off; It can send orders to some appliance like tv and air conditioners as a remote control does."}],"jobAchievements":[{"id":221,"description":"Learn new technologies as Python and Django."},{"id":222,"description":"Learn more frontend using stylus as css preprocessor."}]},{"id":1,"jobTitle":"Software Developer Internship","company":"Sysnet LTDA","time":"Aug 2015 - Nov 2015","jobFunctions":[{"id":111,"description":"Develop new views and functionalities to the business main application."},{"id":112,"description":"Change some things in a new web site developed in wordpress."}],"jobAchievements":[{"id":121,"description":"New knowledges in javascript using Telerik Kendo and JSON."},{"id":122,"description":"Learn to develop Stored Procedures in SQL Server."},{"id":123,"description":"Learn about CMS as Wordpress."}]}]}};
...
function Photo(props) {
    return _react2.default.createElement(
        'figure',
        { className: 'photo' },
        _react2.default.createElement('img', { src: props.photo, alt: props.altPhoto })
    );
}
...
module.exports = __webpack_require__.p + "images/photo.80f204a8040b2c81e9cf00cc94232690.png";
...
var _reactFontawesome = __webpack_require__(30);
...
function Contact(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            'a',
            { href: 'mailto:jfbenavid@gmail.com' },
            _react2.default.createElement(
                'h4',
                null,
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.props.jobs.map(function (item) {
                        return _react2.default.createElement(_Job2.default, _extends({
                            key: item.id,
                            functionDescription: _this2.props.functionDescription,
                            achievementsDescription: _this2.props.achievementsDescription
                        }, item));
                    })
                )
            );
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                'ul',
                null,
                props.jobFunctions.map(function (x) {
                    return _react2.default.createElement(
                        'li',
                        { key: x.id },
                        x.description
            ...
            _react2.default.createElement(
                'span',
                null,
                props.achievementsDescription
            ),
            _react2.default.createElement(
                'ul',
                null,
                props.jobAchievements.map(function (x) {
                    return _react2.default.createElement(
                        'li',
                        { key: x.id },
                        x.description
